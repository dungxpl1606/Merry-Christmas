...
$(document).ready(function () {
  ...
  let text =
    "Hãy để sự ấm áp của mùa lễ hội này mang lại hạnh phúc và sự thoải mái cho cuộc sống của cậu. Chúc cậu có một ngày lễ Giáng sinh vui vẻ, ấm áp, ngọt ngào và đầy ý nghĩa. Chúc mọi căng thẳng của cậu tan biến và mọi ước mơ của cậu đều được thực hiện. Hy vọng mỗi ngày của cậu đều tràn đầy niềm vui!🎄Giáng sinh vui vẻ nhé Phương Linh🎄!";
